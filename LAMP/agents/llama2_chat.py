...
class LLaMa2():
    ...
    def __init__(self,model_name='f',
                 example_num=0,
                 iter=1,
                 log_dir='logs',
                 peft_model=None,
...
def main(path,lora_path):
    llm = LLaMa2(
        model_name='/data/yangzekang/Llama-2-7b-chat-hf',
...
def RULLaMAChat(model_name='/mnt/cachenew/yangzekang/meta-llama/Llama-2-7b-chat-hf',example_num=0,log_dir='logs'):
    llm = LLaMa2(
