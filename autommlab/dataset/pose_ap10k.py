...
class DatasetPoseAP10k(DatasetBaseCoCo):

    CLASSES = ['antelope', 'argali sheep', 'bison', 'buffalo', 'cow', 'sheep',
               'arctic fox', 'dog', 'fox', 'wolf', 'beaver', 'alouatta', 'monkey',
               'noisy night monkey', 'spider monkey', 'uakari', 'deer', 'moose',
               'hamster', 'elephant', 'horse', 'zebra', 'bobcat', 'cat', 'cheetah',
               'jaguar', 'king cheetah', 'leopard', 'lion', 'panther', 'snow leopard',
               'tiger', 'giraffe', 'hippo', 'chimpanzee', 'gorilla', 'orangutan',
               'rabbit', 'skunk', 'mouse', 'rat', 'otter', 'weasel', 'raccoon', 'rhino',
               'marmot', 'squirrel', 'pig', 'mole', 'black bear', 'brown bear', 'panda',
               'polar bear', 'bat']
    ...
    def __init__(self,
                 raw_train_json_file = 'annos/ap10k/annotations/ap10k-train-split1.json',
                 raw_val_json_file = 'annos/ap10k/annotations/ap10k-test-split1.json') -> None:
    ...
    def generate_meta(self, targets, out_dir=None):
        return super().generate_meta(targets, out_dir,sample_num=500,use_metainfo=False)